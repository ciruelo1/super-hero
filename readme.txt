...
API SUPER-HERO: https://superheroapi.com/
tecnologias: visual-studio-code, libreria de material-ui, heroku para los Cors, libreria de rutas
Patron de arquitectura context: usado para proveer proveer un contexto a un componente
Patron de diseño High order component: usado para envolver el componente padre al hijo(superposicion)
Patron de diseño Render Props: usado para transferir propiedades de un componente padre a un hijo, hijo a un padre
